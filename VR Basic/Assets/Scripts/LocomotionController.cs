...
public class LocomotionController : MonoBehaviour
{
    ...
    public GameObject leftRayUIInteractor;
    ...
    {
        _teleportationInputReference = rightRayTeleport.GetComponent<TeleportationController>().inputAction;
    ...
    {
        leftRayTeleport.GetComponent<TeleportationController>().inputAction = _teleportationInputReference;
        rightRayTeleport.GetComponent<TeleportationController>().inputAction = _teleportationInputReference;
